...
class BRC100Wallet {
  ...
  async internalizeAction(a = {}) {
    ...
    await this.storage.insertAction({ txid, description, labels: ['internalized'], status: 'unproven' });
  ...
  async discoverByIdentityKey() {
    return { totalCertificates: 0, certificates: [], note: 'discovery requires an overlay service' };
  }
